  ...
  return (
    <>
      <div className="py-10 text-center text-3xl font-bold text-black">
        ...
        <div className="m-auto flex flex-col max-w-[65%] ">
          <div className=" justify-center space-x-6">
            <div className="">
              ...
              <div className="flex max-w-full border-spacing-3 border">
                ...
                {/* Options */}
                <div className="m-auto flex border-spacing-4 flex-col items-center border border-background-2">
        ...
        <div className="my-20 space-y-4 flex flex-col items-center justify-center">
          <button
            className="flex min-w-80 justify-center space-x-20 rounded-3xl  bg-primary-500 px-4 py-4 text-white"
            // onClick={handleComfirmtOrderClick}
          >
            <p className="text-2xl">前往會員個人信箱</p>
          </button>

          <button
            className="flex min-w-80 justify-center space-x-20 rounded-3xl border border-primary-700 bg-transparent px-4 py-4 text-primary-500"
            onClick={handleGoBackClick}
          >
            <p className="text-2xl">回首頁</p>
          </button>
        </div>
      </div>
    </>
