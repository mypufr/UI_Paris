    ...
    <>
      ...
      <footer className="lg:absolute bottom-0 w-full">
        ...
        <div className="hidden lg:block">
          <img src="/images/footer_background.png" alt="" className="w-full" />
        </div>
        <div className="relative -top-1 h-[350px] bg-primary-600">
          {/* 右側圖片 - 在小螢幕隱藏 */}
          ...
          {/* Footer 文字部分 */}
          <div className="absolute left-10 top-10 md:left-[30%] md:top-[20%] lg:left-[20%] lg:top-[30%]">
            <ul className="space-y-6 text-base text-grey-100">
              {/* 標誌 */}
              <li className="flex">
                <Link to="/" className="inline-flex cursor-pointer">
              ...
              <li>
                <Link to="tel:+37653421" className="flex items-center">
                  ...
                  />
                  <p className="ml-3 inline-block  text-gray-300">03-7653421</p>
                </Link>
              </li>
              <li className="flex items-center">
                <Link to="mailto:info@hexschool.com">
                  <img
                    ...
                    className="inline-block h-6 w-6"
                  />
                  <p className="ml-3 inline-block  text-gray-300">Paris-mon-guide@gmail.com</p>
                </Link>
              </li>
              ...
              <li className="flex space-x-4">
                ...
                <Link
                  to="/"
                  className="inline-block rounded-full border-1"
                >
        ...
        {/* 版權聲明 */}
        <div className="hidden md:absolute  md:translate-x-1/2 md:transform md:bottom-[15%] md:right-[19%]">
