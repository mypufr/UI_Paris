  ...
  return (
    <div className="md: max-w-sm rounded-2xl border-0 border-secondary-300 md:shadow-lg md:border min-[375px]:p-8 md:p-2">
      <Link to="/search-results/:id">
        <div className="rounded-2xl p-1 2xl:px-6 2xl:py-6">
          <img
          ...
          <div className="pt-6">
            ...
            <div className="space-x-2 md:flex md:flex-col md:justify-center md:items-start md:space-x-0 md:space-y-1 min-[1440px]:flex-row min-[1440px]:items-center min-[1440px]:justify-start min-[1440px]:space-y-0 min-[1440px]:space-x-1">
      ...
      <div className="hidden md:flex md:justify-center py-3">
